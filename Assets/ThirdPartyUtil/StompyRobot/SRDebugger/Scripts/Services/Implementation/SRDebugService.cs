namespace SRDebugger.Services.Implementation
{
    ...
    public class SRDebugService : IDebugService
    {
        ...
        public SRDebugService()
        {
            ...
            _entryCodeEnabled = Settings.Instance.RequireCode && Settings.Instance.EntryCode.Count == 6;

            if (Settings.Instance.RequireCode && !_entryCodeEnabled)
            {
                Debug.LogError("[SRDebugger] RequireCode is enabled, but pin is not 6 digits");
            }
