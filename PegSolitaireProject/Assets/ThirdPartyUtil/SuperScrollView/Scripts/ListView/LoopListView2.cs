...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        [SerializeField]
        public Vector2 mViewPortSnapPivot = Vector2.zero;
        [SerializeField]
        public Vector2 mItemSnapPivot = Vector2.zero;
        ClickEventListener mScrollBarClickEventListener = null;
        SnapData mCurSnapData = new SnapData();
        public SnapStatus SnapStatus => mCurSnapData.mSnapStatus;
        ...
        public bool Inited => mListViewInited;
        ...
        public LoopListViewItem2 GetCurShowItemTrans()
        {
            return mItemList[0];
        }
        ...
        */
        ...
        public LoopListViewItem2 GetLastItemInShownItems()
        {
            return mItemList[^1];
        }

        public LoopListViewItem2 GetFirstItemInShowItems()
        {
            return mItemList[0];
        }
